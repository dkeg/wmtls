...
case $1 in
    h|a|east|left)  $file $(next_east)  2>/dev/null ;;
    j|s|south|down) $file $(next_south) 2>/dev/null ;;
    k|w|north|up)   $file $(next_north) 2>/dev/null ;;
    l|d|west|right) $file $(next_west)  2>/dev/null ;;
esac
